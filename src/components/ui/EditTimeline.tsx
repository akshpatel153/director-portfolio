      ...
      <AnimatePresence>
        {hoveredClip && previewImage && (
          <motion.div
            ...
            className="absolute top-0 left-0 pointer-events-none z-[150] w-48 h-32 border-4 border-white bg-black overflow-hidden shadow-[10px_10px_0px_0px_rgba(208,32,32,1)]"
          >
